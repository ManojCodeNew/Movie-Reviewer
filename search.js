...
// let autoSuggestionBox = document.createElement('div');


// Search_box.addEventListener('click', () => {
//     autoSuggestionBox.className = 'autoSuggest';
//     let ispresent = document.querySelector('.autoName')
//     if (!ispresent) {
//         for (let i = 0; i < 5; i++) {
//             let autoSuggestionName = document.createElement('div');
//             autoSuggestionName.className = 'autoName';
//             autoSuggestionName.innerHTML = 'Jawan';
//             autoSuggestionBox.appendChild(autoSuggestionName)
//         }
//         search_box_div.appendChild(autoSuggestionBox)
//     }
